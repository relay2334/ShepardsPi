...
function ngrepParser(interface) {
	...
	function run() {
		...
		var child = spawn('ngrep -d ' + interface + ' -W byline -qilw \'get\' tcp dst port 80', [], {shell: '/bin/bash'}
		);
